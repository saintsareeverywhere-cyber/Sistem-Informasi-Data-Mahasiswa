...
<html lang="en">
  <head>
    ...
    <title>Manajemen Data Mahasiswa | Login</title>
        ...
        <div class="card card-register shadow-sm p-4">
            <div class="card-body">
                ...
                <div class="text-center mb-4">
                     ...
                     <h4 class="card-title mb-0">Masuk Akun</h4>
                     <small class="text-muted">Masukkan Akun Anda</small>
                </div>
                <form action="proses_login.php" method="post">
                    ...
                    <div class="text-center">
                        <small class="text-muted">Belum punya akun? <a href="register.php">Registrasi</a></small>
                    </div>
                </form>
            </div>
        </div>
